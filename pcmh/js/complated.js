...
var complated_demographicsTable= $('#dt_complated_demographics').DataTable( {
  "ajax": "complated/demographics.json",
...
$('#btn_search').click(function(){
  ...
  complated_demographicsTable.search(searchresult).draw();
...
var complated_conditionsandriskTable= $('#dt_complated_conditionsandrisk').DataTable( {
  "ajax": "complated/conditionsandrisk.json",
...
$('#btn_search').click(function(){
 ...
 // var pcmh = $('#pcmh').val();
  var risk = $('#risk').val();
  var searchresult = risk;
  complated_conditionsandriskTable.search(searchresult).draw();
...
var complated_costandutilizationTable= $('#dt_complated_costandutilization').DataTable( {
  "ajax": "complated/costandutilization.json",
...
$('#btn_search').click(function(){
  ...
  var risk = $('#risk').val();
  var searchresult = risk;
  complated_costandutilizationTable.search(searchresult).draw();
...
var complated_bcbsriprogramTable= $('#dt_complated_bcbsriprogram').DataTable( {
  "ajax": "complated/bcbsriprogram.json",
...
$('#btn_search').click(function(){
  ...
  var risk = $('#risk').val();
  var searchresult = risk;
  complated_bcbsriprogramTable.search(searchresult).draw();
...
var complated_patientpanelalldataTable= $('#dt_complated_patientpanelalldata').DataTable( {
  "ajax": "complated/patient_all_data.json",
...
$('#btn_search').click(function(){
  ...
  var risk = $('#risk').val();
  var searchresult = risk;
  complated_patientpanelalldataTable.search(searchresult).draw();
